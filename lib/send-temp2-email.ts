            ...
            Message: {
                Body: {
                    Html: {
                        ...
                        <tr>
                        <td class="pad">
                        <h1 style="margin: 0; color: #000000; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;"><span class="tinyMce-placeholder">${title}</span></h1>
                        </td>
                        </tr>
                        </table>
                        ...
                        <div align="center" class="alignment" style="line-height:10px">
                            <!-- Image link chage it to dynamic -->
                        <div style="max-width: 500px;"><img height="auto" src=${imageUrl} style="display: block; height: auto; border: 0; width: 100%;" width="500"/></div>   
                        </div>
                        </td>
                        </tr>
                        </table>
